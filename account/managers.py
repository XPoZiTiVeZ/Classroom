...
allowedLettersForUsername = 'abcdefghijklmnopqrstuvwxyzABCDEFHIJKLMNOPQRSTUVWXYZабвгдежзийклмнопрстуфхчцшщъыьэюяАБВГДЕЁЖЗИЙКЛМОНПРСТУФХЦЧШЩЪЫЬЭЮЯ'
...
class Manager(BaseUserManager):
    ...
    def create_superuser(self, username, password, **extra_fields):
        ...
        return self.create_user(username, "lukashevda@inbox.ru", password, **extra_fields)